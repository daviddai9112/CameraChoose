...
<body>
	<div id="header">
		<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="research_funds.do">CFS</a>
			</div>
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a href="viewTransactionHistory.do">View Transaction
									History</a></li>
							<li><a href="logout.do">Log out</a></li>
						</ul></li>
					<!-- <li><a href="">Contact Us</a></li> -->
				</ul>
				<form class="navbar-form navbar-right" action="research_funds.do"
					method="POST">
					<div class="form-group">
						<div class="input-group">
							<input class="form-control" name="fundKeyWord" type="search"
								placeholder="Search Funds"> <span
	...
	<br/>
	<br/>
		<a href="research_funds.do">CFS</a>
		<ul>
			<li><a href="research_funds.do">Research Funds</a></li>
			<li><a href="buyfund.do">Buy Funds</a></li>
			<li><a href="sellfund.do">Sell Funds</a></li>
		...
		<form action="research_funds.do" method="POST">
			<div>
				<div>
					<input style="color: black" name="fundKeyWord" type="search" placeholder="Search Funds" >
					<span>
						<button type="submit" >
